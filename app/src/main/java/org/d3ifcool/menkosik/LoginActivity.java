...
public class LoginActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Toolbar ToolBarAtas2 = (Toolbar)findViewById(R.id.toolbar_login);
        ...
        TextView resetPass = (TextView) findViewById(R.id.lupa_password);
        ...
        TextView register = (TextView) findViewById(R.id.registered);
